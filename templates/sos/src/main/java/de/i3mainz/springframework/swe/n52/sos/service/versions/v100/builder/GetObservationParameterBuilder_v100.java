 ...
 */
package de.i3mainz.springframework.swe.n52.sos.service.versions.v100.builder;
...
public class GetObservationParameterBuilder_v100 {
    ...
    private final List<String> eventTimeList = new ArrayList<>();
    private final List<String> procedureList = new ArrayList<>();
    private final List<String> observedPropertyList = new ArrayList<>();
     ...
     *            the observed property parameter
     * @param responseFormat
     *            the response format parameter
     */
    public GetObservationParameterBuilder_v100(final String offering, final String observedProperty,
            final String responseFormat) throws IllegalArgumentException {
        if (offering == null || observedProperty == null || responseFormat == null) {
            throw new IllegalArgumentException(
                    "The parameters \"offering\", \"observedProperty\" and \"responseFormat\" are mandatory. They cannot be left empty!");
        }
     ...
     * @throws OXFException
     *             if ParameterShell can't be created
     */
    public Map<String, Object> getParameters() throws OXFException {
        // preparing multiple occurrence of observed property parameter for
        // SOSWrapper
        final String[] observedProperties = observedPropertyList.toArray(new String[observedPropertyList.size()]);
        final Parameter observedPropertyParameter = new Parameter(GET_OBSERVATION_OBSERVED_PROPERTY_PARAMETER, true,
                new StringValueDomain(observedProperties), GET_OBSERVATION_OBSERVED_PROPERTY_PARAMETER);
        ...
        if (!eventTimeList.isEmpty()) {
            ...
            final Parameter eventTimeParameter = new Parameter(GET_OBSERVATION_EVENT_TIME_PARAMETER, true,
                    new StringValueDomain(eventTimes), GET_OBSERVATION_EVENT_TIME_PARAMETER);
        ...
        if (!procedureList.isEmpty()) {
            ...
            final Parameter procedureParameter = new Parameter(GET_OBSERVATION_PROCEDURE_PARAMETER, true,
                    new StringValueDomain(procedures), GET_OBSERVATION_PROCEDURE_PARAMETER);
     ...
     *            the Feature of Interest as text
     * @return parameter builder
     */
