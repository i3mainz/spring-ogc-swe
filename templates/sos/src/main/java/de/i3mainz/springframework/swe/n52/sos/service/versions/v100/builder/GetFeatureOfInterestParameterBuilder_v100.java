...
public class GetFeatureOfInterestParameterBuilder_v100 {
     ...
     *            the FOI identification parameter
    ...
    public GetFeatureOfInterestParameterBuilder_v100(final String identification, final String identificationType) {
        if (identification == null || identificationType == null || (!identificationType.equals(GET_FOI_ID_PARAMETER)
                && !identificationType.equals(GET_FOI_LOCATION_PARAMETER))) {
            throw new IllegalArgumentException(
                    "The parameters \"identification\" and \"identificationType\" are mandatory. "
